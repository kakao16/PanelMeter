...
void LCD1602_SetCursor(uint8_t col, uint8_t row) {
	switch(row){
		case 0:
			LCD1602_Write8(LCD_SETDDRAMADDR |(col+LCD_LINE0),0);
			break;
		case 1:
			LCD1602_Write8(LCD_SETDDRAMADDR |(col+LCD_LINE1),0);
			break;
		case 2:
			LCD1602_Write8(LCD_SETDDRAMADDR |(col+LCD_LINE2),0);
			break;
		case 3:
			LCD1602_Write8(LCD_SETDDRAMADDR |(col+LCD_LINE3),0);
			break;
	}
}
